...
const FAKE_MODALS: Record<string, Modal> = {
    ...
    body: [
      {
        type: 'paragraph',
        id: 'p1',
        text: 'Texto falso de maqueta para el layout large (text). Aquí se probará el hero de imagen con el texto editorial a la derecha, el scroll interno y la jerarquía del encabezado.',
      },
  ...
  'galeria-fake': {
    ...
    body: [
      {
        type: 'carousel',
        id: 'galeria-fake-carousel',
        images: [
          { src: ph('FOTO 1', '#0599b7', '#046c81'), alt: 'Foto 1' },
          { src: ph('FOTO 2', '#b98a5e', '#8a5a2f'), alt: 'Foto 2' },
          { src: ph('FOTO 3', '#2f4f38', '#1c3323'), alt: 'Foto 3' },
        ],
      },
    ],
        trigger: {
